...
<div class="instagram-widget">
    <a href="http://instagram.com/<?= $userName; ?>" target="_blank" class="title">
        <img
        ...
        <table class="profile">
            ...
            <tr>
                <td colspan="3" style="border-right:none !important;">
                    <a href="http://instagram.com/' . $userName . '" class="follow" target="_blank">' ./*$inWidget->lang['buttonFollow']*/
            'Посмотреть' . ' &#9658;</a>
                </td>
            </tr>
        </table>';
...
<?php
$title_text_width = $width - 44;
$title_text_display = ($width < 160) ? 'display: none;' : '';
